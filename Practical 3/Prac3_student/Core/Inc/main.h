...
#define outLeft_Pin LL_GPIO_PIN_8 //PA8
#define outMLeft_Pin LL_GPIO_PIN_9 //PA8
#define outMRight_Pin LL_GPIO_PIN_10 //PA8
#define outRight_Pin LL_GPIO_PIN_11 //PA8
